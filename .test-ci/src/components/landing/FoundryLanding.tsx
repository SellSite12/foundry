...
// Phase 1 landing page, ported into the app shell. Fonts are loaded via
// next/font in the root layout and keyframes live in globals.css.
// CTAs are wired to the real auth flow (/login, /signup).
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span
            className="fdy-display font-semibold text-[15px] tracking-tight"
            style={{ color: C.text }}
          >
            Foundry
          </span>
      ...
      {open && (
        ...
        >
          ...
          {isAuthed ? (
            <Link
              href="/dashboard"
              className="text-sm font-semibold rounded-full py-2.5 text-center"
            ...
            <>
              <Link href="/login" className="text-sm" style={{ color: C.textDim }}>
                Sign in
              </Link>
              <Link
                href="/signup"
      ...
      >
        ...
        >
          <span
            ...
            style={{
              background: C.copper,
              animation: "fdy-pulse-glow 2s ease-in-out infinite",
            }}
          />
          NOW FORGING V2.0
        </div>
        ...
        <div className="mt-14 flex flex-wrap justify-center gap-x-12 gap-y-6">
          {stats.map((s) => (
            <div key={s.label} className="text-center">
              <div
                className="fdy-mono font-semibold text-[22px]"
                style={{ color: C.text }}
              >
                {s.value}
              </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <span
                className="fdy-mono text-[11px] ml-3"
          ...
          >
            ...
            <div
              className="fdy-mono text-[13px] font-semibold"
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <div
            className="fdy-display font-semibold text-[26px]"
            style={{ color: C.text }}
          >
            $34,912
          </div>
      ...
      <div className="grid grid-cols-3 gap-3 mt-5">
        {[
          ...
          >
            <div className="text-[10.5px]" style={{ color: C.textFaint }}>
              {s.l}
            </div>
            <div
              className="fdy-mono text-[15px] font-semibold"
              style={{ color: C.text }}
            >
              {s.v}
            </div>
      ...
      <div className="max-w-6xl mx-auto">
        <Reveal>
          <div className="max-w-xl mb-16">
            ...
            <h2
              className="fdy-display font-semibold mt-3 text-[clamp(1.8rem,3.4vw,2.6rem)] leading-tight"
              style={{ color: C.text }}
            >
          ...
          {features.map((f, i) => (
            <Reveal key={f.title} delay={i * 70}>
              ...
              >
                ...
                <h3
                  className="fdy-display font-semibold text-[16.5px] mb-2"
                  style={{ color: C.text }}
                >
                  {f.title}
                </h3>
      ...
      <div className="max-w-6xl mx-auto">
        <Reveal>
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2
              className="fdy-display font-semibold mt-3 text-[clamp(1.8rem,3.4vw,2.6rem)]"
              style={{ color: C.text }}
            >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: t.highlight
                    ? "0 20px 60px rgba(232,163,61,0.12)"
                    : "none",
                }}
              >
                {t.highlight && (
                ...
                <h3
                  className="fdy-display font-semibold text-[19px]"
                  style={{ color: C.text }}
                >
                  {t.name}
                </h3>
                ...
                <div className="flex items-baseline gap-1 mb-6">
                  <span
                    className="fdy-display font-semibold text-[36px]"
                    style={{ color: C.text }}
                  >
        ...
        <Reveal>
          ...
          >
            <div
              ...
              style={{
                animation: "fdy-marquee 22s linear infinite",
                color: C.textFaint,
              }}
            >
              {[...logos, ...logos].map((l, i) => (
...
function Footer() {
  ...
  return (
    <footer
      className="relative pt-20 pb-10 px-4 sm:px-6"
      style={{ borderTop: `1px solid ${C.line}`, zIndex: 1 }}
    >
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-16">
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span
                className="fdy-display font-semibold text-[15px]"
                style={{ color: C.text }}
              >
                Foundry
              </span>
            ...
            <p
              ...
              style={{ color: C.textFaint }}
            >
              One platform to cast a store, price a product, and run the
              business behind it.
            </p>
            <div className="flex items-center gap-4 mt-6">
              <AtSign size={16} color={C.textFaint} />
              <Globe size={16} color={C.textFaint} />
              <Rss size={16} color={C.textFaint} />
            </div>
          </div>
          ...
          {cols.map((c) => (
            <div key={c.title}>
              <div
                className="fdy-mono text-[11px] mb-4"
                style={{ color: C.textFaint }}
              >
                {c.title.toUpperCase()}
              </div>
...
/*  ROOT                                                                */
/* ------------------------------------------------------------------ */
export default function FoundryLanding({ isAuthed = false }: { isAuthed?: boolean }) {
  return (
    <div className="fdy-root min-h-screen w-full overflow-x-hidden">
